  ...
  return (
    <>
      {!session ? (
        ...
        <>
          <section className="banner bg-customKhaki relative pb-16">
            <div className="ps-8 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between relative">
              ...
              <div className="flex flex-col items-start justify-center lg:w-1/2 px-4 z-10 relative ">
                <h1 className="text-4xl lg:text-6xl font-bold text-customGreen mb-6 leading-tight">
          ...
          <section className="our-story py-24">
            <div className="container mx-auto grid grid-cols-12 gap-8 items-center">
              ...
              <div className="col-span-5">
                ...
                <p className="text-lg leading-relaxed text-customGray">
                ...
                <p className="text-lg leading-relaxed text-customGray mt-4">
          ...
          <section className="our-work ">
            <div className="container mx-auto flex justify-between items-center">
              <h1 className="text-6xl w-full font-bold text-center mb-16 mr-64">What we do</h1>
              <p className="text-customGray text-2xl mb-16">
          ...
          <section className="join-community">
            <div className="flex justify-between items-start relative">
              <div className="bg-customKhakiDark flex flex-col items-center text-center w-1/2 p-20 relative">
                <p className="text-6xl font-semibold text-white p-7 capitalize">join our <br/>community now</p>
                <div className="flex justify-center items-center w-1/2 p-8 bg-customKhaki">
                  <Link href="https://chat.whatsapp.com/JGEOkOlVK85CbMLP74BAM9">
                  <Image src="/icons/qr_code.png" alt="QR Code" width={400} height={400} />
                  </Link>
                </div>
              </div>
              <div className="centered grid grid-cols-2 gap-4 items-center w-1/2">
                {/* Activity 1 */}
                <div className="flex flex-col items-center p-10">
                  ...
                  <p className="font-medium text-customGray">Networking</p>
                </div>
                {/* Activity 2 */}
                <div className="flex flex-col items-center p-10">
                  <div className="text-4xl text-customGreen mb-2">
                  ...
                  <p className="font-medium text-customGray">Educational Activities</p>
                </div>
                {/* Activity 3 */}
                <div className="flex flex-col items-center p-10">
                  <div className="text-4xl text-customGreen mb-2">
                  ...
                  <p className="font-medium text-customGray">Student Life Activities</p>
                </div>
                {/* Activity 4 */}
                <div className="flex flex-col items-center p-10">
                  <div className="text-4xl text-customGreen mb-2">
                  ...
                  <p className="font-medium text-customGray">Promote Bangladeshi Culture</p>
                </div>
              </div>
              <div style={{width: '60.75%', bottom: '18.75%'}} className="bg-customKhaki mt-16 lg:mt-8 py-8 px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center absolute right-0 shadow-xl">
                {/* Stat 1 */}
                <div className="flex flex-col items-center">
                  <div className="text-4xl text-customGreen mb-2">
                    <Image src="/icons/occupation.svg" alt="Occupation Icon" width={50} height={50} />
                  </div>
                  <p className="text-2xl font-bold text-customGreen">7</p>
                  <p className="uppercase text-lg font-medium text-customGray">Executives</p>
                </div>
                {/* Stat 2 */}
                <div className="flex flex-col items-center">
                  <div className="text-4xl text-customGreen mb-2">
                    <Image src="/icons/teamwork.svg" alt="Teamwork Icon" width={50} height={50} />
                  </div>
                  <p className="text-2xl font-bold text-customGreen">600+</p>
                  <p className="uppercase text-lg font-medium text-customGray">Members</p>
                </div>
                {/* Stat 3 */}
                <div className="flex flex-col items-center">
                  <div className="text-4xl text-customGreen mb-2">
                    <Image src='/icons/community.svg' alt='Community Icon' width={50} height={50} />
                  </div>
                  <p className="text-2xl font-bold text-customGreen">1</p>
                  <p className="uppercase text-lg font-medium text-customGray">Community</p>
                </div>
              </div>
            </div>
          </section>
          <section className="upcoming-events">
            <div className="container my-32 mx-auto flex flex-col items-center justify-center text-center">
              <p className="font-bold text-4xl pb-10">Upcoming and Recent Events</p>
              <div className="grid grid-cols-3 items-center align-middle gap-48 py-12">
                <div className="flex flex-col items-center ">
          ...
          <section className="newsletter-signup">
            <div className="bg-customKhakiDark flex items-center justify-center py-20">
              <div style={{paddingRight:'0'}} className="container bg-white mx-auto flex justify-center items-center w-full shadow-xl border-0 rounded-xl">
                <input type="email" name="newsletter-signup" id="newsletterSignup" placeholder='Sign you with your email for newsletter and events updates' className='px-4 py-5  text-customGreen placeholder:text-customGreen  focus:outline-none focus:ring-0 text-xl w-full '/>
                <button className="bg-customGreen text-left text-white px-6 py-5 text-xl rounded-r-xl w-5/12">Sign Up for Newsletters</button>
              </div>
            </div>
          </section>
        </>
